...
class Meetings_SimpleORMap implements ArrayAccess, Countable, IteratorAggregate
{
    /**
     * table row data
     * @var array $content
    ...
    public function initRelation($relation)
    {
        ...
        if ($this->relations[$relation] === null) {
            ...
            if ($options['type'] === 'has_many') {
                ...
                $this->relations[$relation] = new Meetings_SimpleORMapCollection($records, $options, $this);
