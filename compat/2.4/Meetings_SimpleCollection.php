 ...
 * @category    Stud.IP
*/
class Meetings_SimpleCollection extends StudipArrayObject
{
    ...
    {
        return new Meetings_SimpleCollection($data);
    }
    ...
    public static function getCompFunc($operator, $args)
    {
        if ($operator instanceOf Closure) {
            ...
            switch ($operator) {
                ...
                case '%=':
                    $comp_func = function($a) use ($args) {
                        $a = strtolower(Meetings_SimpleCollection::translitLatin1($a));
                        $args = array_map('Meetings_SimpleCollection::translitLatin1', $args);
    ...
    {
        return parent::exchangeArray(array_map('Meetings_SimpleCollection::arrayToArrayObject', $input));
    }
    ...
    {
        return parent::append(Meetings_SimpleCollection::arrayToArrayObject($newval));
    }
    ...
    function offsetSet($index, $newval)
    {
        ...
        return parent::offsetSet($index, Meetings_SimpleCollection::arrayToArrayObject($newval));
    }
        ...
        $func = function ($d1, $d2) use ($sorter, $sort_func, $sort_locale) {
            do {
                ...
                if (!$sort_locale) {
                    ...
                    $value1 = Meetings_SimpleCollection::translitLatin1(substr($d1[$field], 0, 100));
                    $value2 = Meetings_SimpleCollection::translitLatin1(substr($d2[$field], 0, 100));
                }
